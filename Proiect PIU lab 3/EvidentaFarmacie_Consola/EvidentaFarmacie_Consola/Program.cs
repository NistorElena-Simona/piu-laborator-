...
namespace EvidentaFarmacie_Consola
{
    class Program
    {
            ...
            do
            {
                ...
                switch (optiune.ToUpper())
                {
                    ...
                    case "A":
                        ...
                        break;
                    case "F":
                       lista_medicamente_fisier  = adminMedicament.GetmedicamentedinFisier(numeFisier);
                        AfisareMedicamente(lista_medicamente_fisier, nr_medicamente);
        ...
        public static void AfisareMedicamente(Medicament[] n, int nr_medicamente)
        {
            ...
            {
               string infomedicament = string.Format("Medicamentul cu id-ul #{0} are cutii in nr de: {1} {2}",
                 n[contor].GetIdMedicament(),
                 n[contor].GetNume_medicament() ?? " NECUNOSCUT ",
                 n[contor].GetNr_Medicamente()?? " NECUNOSCUT ");
